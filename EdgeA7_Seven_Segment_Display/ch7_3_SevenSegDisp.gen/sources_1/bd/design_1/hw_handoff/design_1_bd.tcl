...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Seven_Seg [ create_bd_port -dir O -from 7 -to 0 Seven_Seg ]
  set digit_sel [ create_bd_port -dir O -from 3 -to 0 digit_sel ]
  ...
  connect_bd_net -net clk_wiz_0_clk_5MHz [get_bd_pins clk_wiz_0/clk_5MHz] [get_bd_pins display_ctrl_0/clk_5Mhz]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins display_ctrl_0/clk_locked]
  connect_bd_net -net display_ctrl_0_display_select [get_bd_ports digit_sel] [get_bd_pins display_ctrl_0/display_select]
  connect_bd_net -net main_0_output_led [get_bd_ports led] [get_bd_pins main_0/output_led]
  connect_bd_net -net main_0_seven_7 [get_bd_ports Seven_Seg] [get_bd_pins main_0/seven_7]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins main_0/switch]
