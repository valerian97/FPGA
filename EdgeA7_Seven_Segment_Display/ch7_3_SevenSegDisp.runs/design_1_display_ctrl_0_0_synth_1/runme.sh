...
HD_PWD='C:/Users/Carlton/DigitalSystemDesignBook/ch7_3_SevenSegDisp/ch7_3_SevenSegDisp.runs/design_1_display_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_display_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_display_ctrl_0_0.tcl
