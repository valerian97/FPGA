...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(switch, clock, clk_5M, clk_locked, seven_7)
/* synthesis syn_black_box black_box_pad_pin="switch[4:0],clock,clk_5M,clk_locked,seven_7[7:0]" */;
  input [4:0]switch;
  input clock;
  input clk_5M;
  input clk_locked;
